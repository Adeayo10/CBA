...
public class LedgerService : ILedgerService
{
    ...
    public async Task<LedgerResponse> GetGlAccounts(int pageNumber, int pageSize /*string filterValue*/)
    {
    ...
    public async Task<LedgerResponse> UpdateGLAccount(LedgerRequestDTO ledgerRequestDTO)
    {
        ...
        UpdateAccountDetails(glAccount, ledgerRequestDTO);
    ...
    private async void UpdateAccountDetails(GLAccounts glAccount, LedgerRequestDTO ledgerRequestDTO)
    {
    ...
    {
        var glAccount = GetGLAccountById(id).Result.Data;
        if (glAccount == null)
        {
            _logger.LogInformation("Account not found");
            return CreateErrorResponse<LedgerResponse>("Account not found");
    ...
    public async Task<CustomerResponse> UnLinkUserToGLAccount(UserLedgerid userLedgerid)
    {
